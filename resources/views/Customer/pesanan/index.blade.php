...
<div class="container mx-auto mt-24 px-6">
    <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <p class="text-gray-600 mb-6">Berikut adalah daftar pesanan servis Anda. Silakan cek status atau lakukan
            tindakan jika diperlukan.</p>
